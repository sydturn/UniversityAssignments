    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(reader.hasNextLine()) {
                ...
                System.out.println("\n\nProcess P" + x + " is requesting more resources!");
    ...
    private static void testBankers() {
        ...
        while(!pN.isEmpty()) {
            ...
            try {
                ...
                System.out.print("P" + temp.getActualName() + (pN.isEmpty() ? " " : ", "));
            }
            catch(unrunnableException e) {
                if(hesitate) {
                    System.out.println("... Request would result in an unsafe state, do not grant request.");
                    break;
                }
                pN.add(temp);
            }
